        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <form action="<?php echo base_url();?>addcustomerfdbk/" enctype="multipart/form-data" method="POST" id="signup-form" class="signup-form">
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Comment*</label>
                                        <textarea type="text" name="comment" class="form-control" required="true"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
