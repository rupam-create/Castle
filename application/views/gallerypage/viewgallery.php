<section class="content">
    <div class="body_scroll">
        <div class="container-fluid">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <center><a href='#' class="btn btn-sm btn-success editValue gallery_edit" data-name="<?php echo $r->name;?>" data-id="<?php echo $r->id;?>" data-image="<?php echo base_url();?>upload/gallery/<?php echo $r->image;?>">
                                               Edit
                                                </a></center>
                                          <center><?php echo "<a class='btn btn-sm btn-danger delete' href=".base_url()."gallerydel/".$r->id.">Delete</a>"?></center></td>
                                        </tr>
                                          <?php
                                          }
                                          ?>
            ...
            <div class="modal fade" id="gallerypart_Edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?php echo base_url();?>galleryupdate" method="post" enctype="multipart/form-data">
